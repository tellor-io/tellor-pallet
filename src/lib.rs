	...
	impl<T: Config> Pallet<T> {
		...
		pub fn register(origin: OriginFor<T>) -> DispatchResult {
			...
			let weights = Weights {
				...
				report_staking_withdraw_request: T::WeightInfo::report_staking_withdraw_request().ref_time(),
				...
				report_vote_executed: T::WeightInfo::report_vote_executed(T::MaxTimestamps::get()).ref_time(),
